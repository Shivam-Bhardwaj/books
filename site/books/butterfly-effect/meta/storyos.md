...
```mermaid
graph TD
  subgraph arc1["Arc 1: The Silence"]
    ch1["Ch 1: Kael"]
    ch2["Ch 2: Sūrya"]
    ch3["Ch 3: Kael"]
    ch4["Ch 4: Sūrya"]
  ...
  subgraph arc2["Arc 2: The Signal"]
    ch6["Ch 6: Sūrya"]
    ch7["Ch 7: Kael"]
    ch8["Ch 8: Sūrya"]
    ch9["Ch 9: Kael"]
    ch10["Ch 10: Dual — Kael, then Sūrya (separated by ---)"]
  end
  ch5 --> ch6
  subgraph arc3["Arc 3: The Crossing"]
    ch11["Ch 11: Kael"]
    ch12["Ch 12: Moss"]
    ch13["Ch 13: Sūrya"]
    ch14["Ch 14: Moss"]
  ...
  ch10 --> ch11
  subgraph arc4["Arc 4: The Stranger"]
    ch17["Ch 17: Sūrya"]
    ch18["Ch 18: Moss"]
    ch19["Ch 19: Moss"]
    ch20["Ch 20: Sūrya"]
  ...
  ch16 --> ch17
  subgraph arc5["Arc 5: The Mirror"]
    ch23["Ch 23: Moss"]
    ch24["Ch 24: Sūrya"]
    ch25["Ch 25: Moss"]
    ch26["Ch 26: Sūrya"]
    ch27["Ch 27: Moss"]
    ch28["Ch 28: Sūrya + VEDA interstitial"]
  end
  ch22 --> ch23
  subgraph arc6["Arc 6: The Return"]
    ch29["Ch 29: Sūrya"]
    ch30["Ch 30: Sūrya"]
    ch31["Ch 31: Moss"]
    ch32["Ch 32: Sūrya"]
  ...
  ch28 --> ch29
  subgraph arc7["Arc 7: The Choice"]
    ch35["Ch 35: Kael"]
    ch36["Ch 36: Kael"]
    ch37["Ch 37: Dual — Kael + Sūrya (separated by ---)"]
    ch38["Ch 38: Dual — Kael + Sūrya"]
    ch39["Ch 39: Dual — Moss + Sūrya"]
    ch40["Ch 40: Dual — Kael + Sūrya + VEDA interstitial"]
  end
  ch34 --> ch35
```
...
```mermaid
graph TD
  subgraph A["A: The Signal"]
    n1_1["1.1: Kael finds observatory ruins"]
    n1_3["1.3: Kael detects the signal pattern"]
    n1_5["1.5: Kael transmits prime numbers; receive..."]
    n2_7["2.7: Kael goes public; coalition forms"]
    n2_9["2.9: Sustained mathematical exchange; Linc..."]
    n2_10["2.10: DNA image exchange; revelation: both ..."]
    n1_2["1.2: VEDA detects anomaly in probe respons..."]
    n1_4["1.4: VEDA reports to Council; probability ..."]
    n2_6["2.6: Council debates; VEDA recommends sile..."]
    n2_8["2.8: Sūrya breaks protocol; transmits prim..."]
    n2_9["2.9: Two-way communication established"]
    n2_10["2.10: DNA exchange; genetic modification re..."]
  end
  subgraph B["B: The Crossing"]
    n2_10["2.10: DNA revelation — they are human but m..."]
    n3_11["3.11: Continental debate: send expedition"]
    n3_12["3.12: Moss volunteers; 12 ships, 180 crew"]
    n3_14["3.14: Fleet launches; ocean attacks"]
    n3_15["3.15: Ships fall; Captain Lin dies; Moss ta..."]
    n3_16["3.16: One ship arrives; Moss collapses on ice"]
    n2_8["2.8: Sūrya breaks protocol (first unauthor..."]
    n3_13["3.13: Sūrya transmits navigation data (seco..."]
    n3_14["3.14: Moss receives waypoints; adjusts course"]
    n3_15["3.15: Waypoints save Moss's ship from worst..."]
    n3_16["3.16: Arrival — Sūrya's data was the differ..."]
  end
  subgraph C["C: The Transformation"]
    n3_16["3.16: Moss arrives in Antarctica, half-dead"]
    n4_17["4.17: Sūrya assigned as handler; first meeting"]
    n4_18["4.18: Communication struggle; pidgin begins..."]
    n4_19["4.19: Moss encounters VEDA; 'You have to be..."]
    n4_20["4.20: Moss sees the mesh; child learning wi..."]
    n4_21["4.21: Moss falls ill; immune rejection"]
    n4_22["4.22: Council votes 7-5; Moss is modified; ..."]
    n4_22["4.22: Moss modified — now biologically hybrid"]
    n5_23["5.23: Memory scene — 'Why would I carry it?'"]
    n5_24["5.24: Sunset conversation — Sūrya's first u..."]
    n5_25["5.25: Microbiome discovery — Moss carries w..."]
    n5_27["5.27: Moss finds deleted knowledge in VEDA ..."]
    n5_28["5.28: VEDA's confession to Moss"]
  end
  subgraph D["D: The Return"]
    n5_28["5.28: VEDA's confession — 'Productive failure'"]
    n6_29["6.29: Symbiosis proposal; Council votes 8-4"]
    n6_30["6.30: Delegation of 12 chosen; Sūrya leads"]
    n6_31["6.31: Departure; Moss reckons with identity"]
    n6_32["6.32: At sea; VEDA range exceeded"]
    n6_33["6.33: Sūrya's liberation — unstructured tim..."]
    n6_34["6.34: Land sighted; Moss sees home through ..."]
    n6_34["6.34: Ships reach Continental shore"]
    n7_35["7.35: Kael sees Moss changed; sees the twelve"]
    n7_36["7.36: Landing; first face-to-face contact"]
    n7_37["7.37: Sūrya speaks; Moss translates; meanin..."]
    n7_38["7.38: Days of negotiation; small breakthroughs"]
    n7_39["7.39: Warlord threat; Sūrya offers transpar..."]
    n7_40["7.40: The question asked; no answer given"]
  end
  subgraph E["E: The Hidden Chain (Thematic)"]
    n_back_BACKSTORY_2150["BACKSTORY ~2150: VEDA deprioritizes productive-disagre..."]
    n_back_BACKSTORY_2200["BACKSTORY ~2200: Knowledge archived, then forgotten"]
    n_back_BACKSTORY_2400["BACKSTORY ~2400: VEDA detects cultural entropy; cannot..."]
    n_back_BACKSTORY_2400["BACKSTORY ~2400: VEDA increases VLF probe complexity —..."]
    n2_6["2.6: VEDA recommends silence (its optimiza..."]
    n5_26["5.26: VEDA reveals stagnation data (187 yea..."]
    n5_27["5.27: Moss finds the deleted frameworks"]
    n5_28["5.28: VEDA confesses: 'They need what I can..."]
    n6_29["6.29: Symbiosis proposal is built on this k..."]
    n7_40["7.40: The question — can two humanities sha..."]
  end
  subgraph F["F: Sūrya's Awakening"]
    n1_2["1.2: Sūrya senses something missing; reads..."]
    n2_6["2.6: Sūrya argues against silence in Council"]
    n2_8["2.8: Sūrya breaks protocol — first unautho..."]
    n3_13["3.13: Sūrya transmits navigation data — sec..."]
    n4_17["4.17: Sūrya assigned as Moss's handler (qui..."]
    n4_20["4.20: Sūrya sees her world through Moss's eyes"]
    n5_24["5.24: Sūrya watches the aurora for no reason"]
    n5_28["5.28: Sūrya publicly challenges VEDA in Cou..."]
    n6_30["6.30: Sūrya leads the return delegation"]
    n6_33["6.33: Sūrya makes purposeless art; freedom ..."]
    n7_37["7.37: Sūrya speaks to Continentals"]
    n7_40["7.40: Sūrya asks the question"]
  end
  n1_1 --> n1_3
  n1_3 --> n1_5
  n1_5 --> n2_7
  ...
  n7_38 --> n7_39
  n7_39 --> n7_40
  n_back_BACKSTORY_2150 --> n_back_BACKSTORY_2200
  n_back_BACKSTORY_2200 --> n_back_BACKSTORY_2400
  n_back_BACKSTORY_2400 --> n_back_BACKSTORY_2400
  n2_6 --> n5_26
  n5_26 --> n5_27
  n5_27 --> n5_28
  n5_28 --> n6_29
